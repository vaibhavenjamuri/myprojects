...
<header>
  ...
  <section id="content">
    ...
    <input type="hidden" name="viewType" value="visitconfirm" />
    ...
    <tr>
        <td colspan="4"> <h4>Visit Details</h4> </td>
            </tr>
    ...
    <tr><td>&nbsp;</td></tr>  
       <tr>
        ...
        <option value="12">12 </option>
             ...
             <tr><td colspan="2">&nbsp;</td></tr>
               <tr><td>
                   <a href="#" class="button1" onClick="document.ContactForm.submit();"><strong>Confirm Visit</strong></a>
                  </td></tr>  
    </table>
    </form>
  </section>

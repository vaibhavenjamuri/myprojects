...
<div class="main">
  ...
  <header>
    ...
    function deleteOffer(offerId) {
    	document.ContactForm.viewType.value="deleteofferdetails";
    	document.ContactForm.selectedoffer.value=offerId;
    	var r = confirm("Are you sure to delete offer " + offerId);
    	if(r==true) {
    		document.ContactForm.submit();
    	}else {
    		return false;
 ...
 <h3 class="pad_top1" align="center">Delete Offer Details</h3>
        <form id="ContactForm" name="ContactForm" action="offersServlet" method="post">
        <input type="hidden"  class="input"  name="viewType" required="required" value="deleteoffer"/>
    ...
    <td><a href="#"  onClick="deleteOffer('<core:out value="${offer.offerId}"/>');">Delete</a></td>

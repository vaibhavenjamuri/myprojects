...
<div class="main">
  <header>
    ...
    function updateApartment(apartmentCode) {
    	document.ContactForm.viewType.value="editapartmentdetails";
    	document.ContactForm.selectedapartment.value=apartmentCode;
    	document.ContactForm.submit();
    }
 ...
 <h3 class="pad_top1" align="center">Edit Apartment Details</h3>
        <form id="ContactForm" name="ContactForm" action="viewApartmentsServlet" method="post">
        <input type="hidden"  class="input"  name="viewType" required="required" value="editapartment"/>
    ...
    <td><a href="#"  onClick="updateApartment('<core:out value="${apartment.aptId}"/>');">Edit</a></td>

...
<header>
  ...
  <section id="content">
    ...
    <input type="hidden" name="viewType" value="confirmreserve" />
    ...
    <tr>
        <td colspan="4"> <h4>Reservation Details</h4> </td>
            </tr>
    ...
    <tr><td>&nbsp;</td></tr>
      ...
      <tr>
        ...
        <td> <input type="password"  class="input"  name="cvv"  value="123"/></td>
             ...
             <tr><td colspan="2">&nbsp;</td></tr>
               <tr><td>
                   <a href="#" class="button1" onClick="document.ContactForm.submit();"><strong>Confirm</strong></a>
                  </td></tr>  
    </table>
    </form>
  </section>

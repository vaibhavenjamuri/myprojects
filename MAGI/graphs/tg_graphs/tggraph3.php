...
$sql4="SELECT observation_time,prs from t_tide_guage_incois_hourly where station_id='".$markerValue3."' and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";
$jsonArray = array();
$jsonArray2 = array();

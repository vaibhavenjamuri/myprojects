...
$sixMonthsAgo = date("Y-m-d", strtotime("-6 months"));
		$sql4="SELECT observation_time,current_direction from t_wrb_merged where station_id='".$markerValue1."' and flag_current_direction=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

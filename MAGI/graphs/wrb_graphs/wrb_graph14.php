...
$sql4="SELECT observation_time,te from t_wrb_merged where  station_id='".$markerValue1."' and flag_te=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

...
$sql4="SELECT observation_time,ss from t_wrb_merged where  station_id='".$markerValue1."' and flag_ss=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

...
$sql4="SELECT observation_time,ti from t_wrb_merged where  station_id='".$markerValue1."' and flag_ti=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

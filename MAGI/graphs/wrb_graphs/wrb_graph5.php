...
$sixMonthsAgo = date("Y-m-d", strtotime("-6 months"));
		$sql4="SELECT observation_time,t1 from t_wrb_merged where  station_id='".$markerValue1."' and flag_t1=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

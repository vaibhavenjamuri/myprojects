...
$sql4="SELECT observation_time,eps from t_wrb_merged where  station_id='".$markerValue1."' and flag_eps=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

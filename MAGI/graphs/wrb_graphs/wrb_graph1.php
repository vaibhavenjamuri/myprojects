...
//$sql4="SELECT observation_time,hm0 from t_wrb_merged where station_id='".$sname1."' and flag_hm0=1 and observation_time between '".$sdate."' and '".$edate."'";
$sql4="SELECT observation_time,hm0 from t_wrb_merged where station_id='".$markerValue1."' and flag_hm0=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";
$jsonArray = array();
$jsonArray2 = array();

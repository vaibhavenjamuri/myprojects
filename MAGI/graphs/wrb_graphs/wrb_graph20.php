...
$sql4="SELECT observation_time,ay from t_wrb_merged where  station_id='".$markerValue1."' and flag_ay=1 and observation_time between '".$sixMonthsAgo."' and '".$today_date."'";

...
$sql4="SELECT observation_time,wind_speed from t_ndbp_omni_merged where buoy_id='".$markerValue1."' and observation_time between '2024-11-01 00:00:00' and '2024-11-12 00:00:00'";
$jsonArray = array();
$jsonArray2 = array();

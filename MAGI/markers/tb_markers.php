...
//{
//$sql4="select platform_id, last_reported_latitude,last_reported_longitude, last_reported_time,status from t_platforms_live where project like 'TB'";
//}
//else
//{
	//$sql4="select platform_id, last_reported_latitude,last_reported_longitude,last_reported_time,status from t_platforms_live where project like 'TB' and last_reported_time BETWEEN '".$start_date."' AND '".$recv_date."'";
	$sql4="select programme,platform_id, last_reported_latitude,last_reported_longitude,last_reported_time,status from t_platform_present where programme like 'TB' ";

...
//{
 ...
 // INNER JOIN db_wave_rider_buoy.t_wrb_positions t ON t.station_id = u2.station_id where cast(u2.MaxTime as date) BETWEEN '".$start_date."' AND '".$recv_date."'";
  	...
  	$sql4="select programme,platform_id, last_reported_latitude,last_reported_longitude,last_reported_time,status from t_platform_present where programme like 'CAWS'";

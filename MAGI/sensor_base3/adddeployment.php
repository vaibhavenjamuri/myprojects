...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../ExternalLibraries/bootstrap-4.0.0/dist/css/bootstrap.min.css" />
...
<script src="../ExternalLibraries/multiselect-dropdown-main/multiselect-dropdown.js"></script>
...
<body>
    ...
    <div class="container">
            ...
            <div id="main" style="border:solid 1px;padding:35px" >
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
							...
							<option value="Tide Guage">Tide Guage</option>
                               ...
                               <?php
    // $mysqli = new mysqli("172.16.1.57", "webser", "WebSer3010", "db_administration");
    // # check connection
...
<input type="checkbox" id="stype2" name="stype2" value="old" onclick="stype2check()" checked>
<label for="old">Old</label>
                        <div class="col-md-9">
<select class="form-control" name="sname1" id="sname1" onchange="progSelect()">
    ...
    // $mysqli->close();
                            ...
                            <input type="text" style="display:none" class="form-control" id="sname2" name="sname2" >
                        </div>
                    </div>
 ...
 <!--<select class="form-control" name="smodel" id="smodel"   required>-->
							...
							<!--<option value="">Select Sensor Model</option>-->
                               ...
                               <?php
    $mysqli = new mysqli("172.16.1.57", "webser", "WebSer3010", "sensor_base2");
    # check connection
    if ($mysqli->connect_errno) {
        echo "<p>MySQL error no {$mysqli->connect_errno} : {$mysqli->connect_error}</p>";
        exit();
    ...
    // if ($results->num_rows >= 1) {
                ?>
                    ...
                    <div class="col-md-9">
                    <input type="text" class="form-control" id="wmo" name="wmo" required/>
                    </div>
                ...
                <!--<div class="row form-group" >
                    ...
                    <div class="col-md-3">
                        <label id="namep">Primary Detection :</label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="pdetec" id="pdetec" required/>
                    </div>
                ...
                <!-- <div class="row form-group">
                    <div class="col-md-3">
                        <label>Sensor Model Name/Number :</label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="smodel" id="smodel" required/>
                    </div>
                </div>-->
                <!--<div class="row form-group">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="mheight" id="mheight" required/>
                    </div>
                </div>-->
				   <!--<input type="button" value="Add Sensor Data" class="btn btn-primary" onclick="add_field();">
                <div class="row form-group">

                <div id="wrapper" style="padding-left: 16px;">
<div id="field_div">
    ...
    if (isset($_POST['submit'])) {
        ...
        $mysqli = new mysqli("172.16.1.57", "webser", "WebSer3010", "sensor_base3");
        # check connection
        if ($mysqli->connect_errno) {
            echo "<p>MySQL error no {$mysqli->connect_errno} : {$mysqli->connect_error}</p>";
            exit();
...
$phpVar=$_POST['hide1'];
				...
				if($_POST['tstation']=='Tide guage')
	{
		...
		{
			$sql = "SELECT a.new_deployment_date,a.Station_Name from wrb_identification_details a, sensor_models b where a.Deployment_Date=b.Deployment_Date and a.Deployment_Date= ? and a.Station_Name= ? and b.Sensor_Model= ?";
			//$stmt1 = $mysqli->prepare($sql);
		   //$stmt1->bind_param("sss", $ddate,$sname2,$smodel);
	}
       ...
       // $result = mysqli_query($conn, $sql);
            ...
            // } 
						     $stmt1 = $mysqli->prepare($sql);
							  echo $tstation,$sname1,$sname2,$smodel,$lat,$lng,$ddate;
                $stmt1->bind_param("sss", $ddate,$sname2,$smodel);
...
echo '<script type="text/javascript">alert("'.$smodel. '");</script>';
				if($_POST['tstation']=='Tide guage')
	{
		...
		{
	    $sql1 = "INSERT  INTO wrb_identification_details (`type_of_station`,`station_name`,`latitude`,`longitude`,`new_deployment_Date`,`retrieved_drift_date`,redeployment_date,`maintenance_date`, sequence) VALUES (?,?,?,?,?,?,?,?,?)";
		$stmt2 = $mysqli->prepare($sql1);
		$stmt2->bind_param("sssssssss", $tstation,$sname2,$lat,$lng,$ddate,NULL,NULL,NULL,NULL);
		
		}
		 $sql2 = "INSERT  INTO sensor_models (platform_id,Deployment_Date,sensor_model,type_of_station) VALUES (?,?,?,?)";
		  $stmt3 = $mysqli->prepare($sql2);
					 $stmt3->bind_param("ssss",$sname2,$ddate,$smodel,tstation);

                //$sql1 = "INSERT  INTO `Deployment_Details` (`Platform`,`station_name`,`latitude`,`longitude`,`Deployment_Date`,`Sensor_Model`,`bathymetry`,`mesurement_height`) VALUES (?,?,?,?,?,?,?,?)";
       ...
       // $result = mysqli_query($conn, $sql);
            ...
            // } 
						     $stmt1 = $mysqli->prepare($sql);
                $stmt1->bind_param("sss", $ddate,$sname1,$smodel);
				if ($stmt1->execute()) {
					 // echo '<script type="text/javascript">alert("'.$smodel.'Data already exists");</script>';

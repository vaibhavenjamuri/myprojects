...
public class DeleteVAccountServlet extends HttpServlet{
	...
	if(viewType1!=null && "VDelete".equalsIgnoreCase(viewType1)) {
		try {
			...
			if(!deleteAccountsDao.deleteVAccount(payment)) {
				request.setAttribute("errorMsg", "failed to Delete Volunteer Account. Please try again!");
			}else {

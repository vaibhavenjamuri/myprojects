...
<div class="main">
 ...
 <h3 class="pad_top1">New User Form</h3>
        <form id="ContactForm" action="VolunteerProfileServlet" method="post">
        ...
        <td> <input type="text"  class="input"  name="lastname" required="required" value="customer1"/></td>
            ...
            <tr><td>&nbsp;</td></tr>
             <tr>
        <td>  Mobile Number*: </td>
        <td> <input type="text"  class="input"  name="mobileno" data-content="Please use valid format" pattern="^\d{3}\d{3}\d{4}$" required="required" value="8121689601"/></td>
            </tr>

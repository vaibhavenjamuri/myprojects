...
<div class="main">
  ...
  <header>
    ...
    <input type="hidden"  class="input"  name="viewType" value=""/>
      ...
      <li id="menu_active" class="end"><a href="index.jsp"><span><span>Home</span></span></a></li>
        <li id="menu_active" class="end"><a href="AboutPlanetPC.jsp"><span><span>About PlanetTree</span></span></a></li>
  ...
  <!-- / header -->
  <!--content -->
 <pre>“PlanetTree” is a non-profit organization which promotes the planting of trees throughout the region.

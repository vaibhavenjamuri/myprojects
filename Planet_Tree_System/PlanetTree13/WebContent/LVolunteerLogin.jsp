...
<li id="menu_active" class="end"><a href="index.jsp"><span><span>Home</span></span></a></li>
 ...
 <h3 class="pad_top1">Login Form</h3>
        <form id="ContactForm" action="LVolunteerLoginServlet" method="post">
        ...
        <td> <input type="text"  class="input"  name="username" required="required" value=""/></td>
            ...
            <td> <input type="password" class="input" name="userpass" required="required" value=""/></td>
              ...
              <tr>
				...
				<tr><td>&nbsp;</td></tr>
              <tr>
					<td colspan="2" align="center">New User? Click <a href="LVRegister.jsp">here</a> to register.</td>
				</tr>
				
					<tr><td>&nbsp;</td></tr>
              <tr>
					<td colspan="2" align="center"><a href="LVForgotpassword.jsp">Forgot Password</a></td>
				</tr>
              </table>
    </form>
    </div>

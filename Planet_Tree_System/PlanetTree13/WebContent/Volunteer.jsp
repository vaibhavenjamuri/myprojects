...
<div class="wrapper">
    ...
    <input type="hidden"  class="input"  name="viewType" value=""/>
      ...
      <ul id="menu">
         <li><a href="AboutPlanetPV.jsp"><span><span>About PlanetTree</span></span></a></li>
        <li  id="menu_active" class="end"><a href="login.jsp"><span><span>Volunteer Login</span></span></a></li>
      </ul>
      </form>
    </nav>
 ...
 <h3 class="pad_top1">Login Form</h3>
        ...
        <tr>
        <td>  Name: </td>
        <td> <input type="text"  class="input"  name="username" required="required" value="admin"/></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr> <td>Password:</td>
            <td> <input type="password" class="input" name="userpass" required="required" value="admin"/></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>

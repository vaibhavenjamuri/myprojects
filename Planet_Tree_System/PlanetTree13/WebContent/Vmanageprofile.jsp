...
<div class="wrapper">
    ...
    function logoutAction(viewType) {
    	...
    	document.linkForm.action = "VolunteerLoginServlet";
    ...
    function performAction(viewType) {
    	...
    	if(viewType=='viewprofile') {
    		document.linkForm.action = "VolunteerProfileServlet";
    	}
    	document.linkForm.submit();
    }
    </script>
 ...
 <h3 class="pad_top1">Edit Profile</h3>
        <form id="ContactForm" name="ContactForm" action="VolunteerProfileServlet" method="post">

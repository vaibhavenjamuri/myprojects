...
<li id="menu_active"><a href="index.jsp"><span><span>Home</span></span></a></li>
         <li id="menu_active" class="end"><a href="AboutPlanetPA.jsp"><span><span>About PlanetTree</span></span></a></li>
        <li  id="menu_active" class="end"><a href="AdminLogin.jsp"><span><span>AdminLogin</span></span></a></li>
      </ul>
      </form>
    </nav>
 ...
 <h3 class="pad_top1">Admin Login</h3>
